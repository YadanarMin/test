...
function onDocumentLoadSuccessV7(doc) {
    var viewerDiv = document.getElementById('modelViewer');
    var config3d = {
         extensions: ["Autodesk.Viewing.MarkupsCore","AshibaSelection"],
    };
    Autodesk.Viewing.theExtensionManager.registerExtension('ToolbarExtension', ToolbarExtension);
    //Autodesk.Viewing.theExtensionManager.registerExtension('MyAwesomeExtension', MyAwesomeExtension);
    Autodesk.Viewing.theExtensionManager.registerExtension('AshibaSelection', AshibaSelection);
    ...
    if (startedCode > 0) {
        ...
        if(viewer.isLoadDone()){
            ...
            viewer.loadExtension('AshibaSelection');
...
console.log(viewables);
    ...
    var viewerDiv = document.getElementById('myModelViewer');
    viewer = new Autodesk.Viewing.Private.GuiViewer3D(viewerDiv);
