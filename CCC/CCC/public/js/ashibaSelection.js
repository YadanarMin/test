//To add custom extension
function AshibaSelection(viewer, options) {
  ...
  this.load = function() {
    console.log('AshibaSelection is loaded!'); 
  ...
  this.unload = function() {
    console.log('AshibaSelection is now unloaded!');
    //unbind keyup event
  ...
  this.onToolbarCreated = function(){
     this._group = this.viewer.toolbar.getControl('AshibaSelectionToolbar');
    
        if (!this._group) {
            this._group = new Autodesk.Viewing.UI.ControlGroup('AshibaSelectionToolbar');
            this.viewer.toolbar.addControl(this._group);
        }

        // Add a new button to the toolbar group
        this._button = new Autodesk.Viewing.UI.Button('ashibaSelectionButton');
            ...
            if(allId.length == 0){
              ...
              function(e){
                ...
                for(var i in e){
                  ...
                  if(familyName.includes("踏板")||
                       familyName.includes("足場") ||
                       familyName.includes("単管パイプ") ||
                       familyName.includes("布材") ||
                       familyName.includes("アルバトロス階段手摺") ||
                       familyName.includes("アルバトロスブレス") ||
                       familyName.includes("手摺枠") ||
                       familyName.includes("164_ぴたっとブラケット500") ||
                       familyName.includes("56_DSステップ1") ||
                       familyName.includes("壁つなぎ") ||
                       familyName.includes("A39_アルバトロス強化方杖 ") ||
                       familyName.includes("ジャッキベース") ||
                       familyName.includes("固定ベース") ||
                       familyName.includes("杉孝") ||
                       familyName.includes("A2_XP2700SJ") ||
                       familyName.includes("A3_XP1800SJ") ||
                       familyName.includes("A1_XP3600SJ") ||
                       familyName.includes("sugiko") ||
                       familyName.includes("N4_斜材受け金具")){
