...
function outputDocument(templateName){
    ...
    window.location="/iPD/document/outputExcelTemplate/"+templateName+select_pj_code;
}

function outputDocumentNew(templateName){
    ...
    $.ajax({
        url: "../document/outputExcelTemplateNew",
        async:false,
        type: 'post',
        data:{_token: CSRF_TOKEN,templateName:templateName,pjCode:select_pj_code},
        success :function(data) {
