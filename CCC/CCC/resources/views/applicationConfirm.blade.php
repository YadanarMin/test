...
<script>
    $(document).ready(function(){
        ...
        var url = "applicationConfirm/index";
        var content_name = "申し込み内容確認";
    ...
    <div id="application-view">
        <div id="application-bim-insert">
            ...
            <div style=" margin-top: 15%;">
                <button class="btn btn-primary form-control" onclick="window.location='{{ url("/applicationConfirm/edit") }}'" style="margin-bottom: 30px; font-size :16px">
                    内容確認
                </button>
            </div>
        </div>
