...
<script type="text/javascript" src="/iPD/public/js/projectReport_temp.1.js"></script>
                                    ...
                                    <li id="{{$cate['default_name']}}_li" class="col-md-6">
                                      <div class="reports_header">
                                          ...
                                          <div class="text-style">
                                              ...
                                              <div class='style-tab'>
                                                  <button id="ipd_bold" role="button" aria-pressed ="false">B</button>
                                                  <!--<strong><span tabindex="0" role="button" aria-pressed="false" id='ipd_bold'>B</span></strong>-->
                                              </div>
                                              <div class='style-tab'>
                                                  <button id='ipd_underline'  role="button" aria-pressed ="false"><u style="pointer-events :none">U</u></button>
                                                  <!--<u><span tabindex="0" role="button" aria-pressed="false" id='ipd_underline'>U</span></u>-->
                                              </div>
                                              <div class='style-tab'>
                                                  <button id='ipd_strike' role="button" aria-pressed ="false"><strike style="pointer-events :none">ab</strike></button>
                                                  <!--<strike><span tabindex="0" role="button" aria-pressed="false" id='ipd_strike'>ab</span></strike>-->
                                              </div>
                                              <div class='style-tab'>
                                                  <button id='ipd_background_color'>
                                                      <span class="glyphicon glyphicon-pencil">
                                                          <input type="color" class="colorPicker" id='ipd_bg_colorpicker'>
                                                      </span>
                                                  </button>
                                                  
                                             </div>
                                              <div class='style-tab'>
                                                  <button id='ipd_text_color'>A<input type="color" class="colorPicker"></button>
