...
class DerivativesApi extends AbstractApi
{
    ...
    public function getDerivativeManifestWithHttpInfo($urn, $derivative_urn, $range = null)
    {
        ...
        $headerParams['x-ads-region']="US";
        //$headerParams['Range']="bytes=0-100";
        // header params
        if ($range !== null) {
            $headerParams['Range'] = "bytes=".$range;//$this->apiClient->getSerializer()->toHeaderValue($range);
        }
        // path params
        if ($urn !== null) {
            $resourcePath = str_replace(
...
//print_r($response);return;
     ...
     * @return \Autodesk\Forge\Client\Model\Metadata
     */
    public function getModelviewProperties($urn, $guid, $accept_encoding)
    {
     ...
     * @return array of \Autodesk\Forge\Client\Model\Metadata, HTTP status code, HTTP response headers (array of strings)
     */
    public function getModelviewPropertiesWithHttpInfo($urn, $guid, $accept_encoding)
    {
        // verify the required parameter 'urn' is set
        if ($urn === null) {
        ...
        // parse inputs
        $resourcePath = "/modelderivative/v2/designdata/{urn}/metadata/{guid}/properties?forceget=true";
        $httpBody = '';
        $queryParams = [];
        $headerParams = [];
        $formParams = [];
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->callApi(
                ...
                $headerParams,
                '\Autodesk\Forge\Client\Model\Metadata',
                '/modelderivative/v2/designdata/{urn}/metadata/{guid}/properties?forceget=true'
            );
    ...
    public function getModelviewPropertiesByZip($urn, $guid, $accept_encoding)
    {
        list($response) = $this->getModelviewPropertiesWithHttpInfoByZip($urn, $guid, $accept_encoding);
        return $response;
    }
    
    
    public function getModelviewPropertiesWithHttpInfoByZip($urn, $guid, $accept_encoding)
    {
        // verify the required parameter 'urn' is set
        if ($urn === null) {
            throw new \InvalidArgumentException('Missing the required parameter $urn when calling getModelviewProperties');
        ...
        try {
            ...
            //$content = gzinflate(substr($response,10,-8));//$respone is gzid data,then unzip with gzinflate
            //return json_decode((gzinflate(substr($response,10,-8))));
            //$filePath = "/var/www/html/iPD/test.txt";
            //file_put_contents($filePath, $content);
            //return json_decode(array($content),true);
            return json_decode(json_encode(array(gzinflate(substr($response,10,-8)))),true);
    ...
    public function getModelviewPropertiesByObjectId($urn, $guid, $objectid , $accept_encoding = null)
    {
        list($response) = $this->getModelviewPropertiesWithHttpInfoByObjectId($urn, $guid, $objectid ,$accept_encoding);
        return $response;
    }
    
    
    public function getModelviewPropertiesWithHttpInfoByObjectId($urn, $guid,$objectid, $accept_encoding = null)
    {
        // verify the required parameter 'urn' is set
        if ($urn === null) {
            throw new \InvalidArgumentException('Missing the required parameter $urn when calling getModelviewProperties');
        ...
        // parse inputs
        $resourcePath = "/modelderivative/v2/designdata/{urn}/metadata/{guid}/properties?objectid=".$objectid;
        $httpBody = '';
        $queryParams = [];
        $headerParams = [];
        $formParams = [];
        ...
        //$headerParams["x-ads-force"] = false;
        //$headerParams['Accept-Encoding'] = 'gzip';
        // header params
        if ($accept_encoding !== null) {
            $headerParams['Accept-Encoding'] = $this->apiClient->getSerializer()->toHeaderValue($accept_encoding);
        ...
        /*if ($objectid !== null) {
            $resourcePath = str_replace(
                "{" . "objectid" . "}",
                $this->apiClient->getSerializer()->toPathValue($objectid),
                $resourcePath
            );
        }*/
        // default format to json
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->callApi(
                ...
                $headerParams,
                '\Autodesk\Forge\Client\Model\Metadata',
                '/modelderivative/v2/designdata/{urn}/metadata/{guid}/properties?objectid='.$objectid
            );
