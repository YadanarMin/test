...
$(document).ready(function() {
    ...
    $("#minimize-arrow").on("click", function(e) {
        ...
        if ($(this).hasClass("fa-toggle-left")) {
            ...
            if (!$("#general_report_info").hasClass('general_info_minimize')) {
                $("#report-item-group").removeClass("col-md-7 col-md-12");
                $("#general_report_info").removeClass("col-md-5");
            ...
            //general info part
            if (!$("#general_report_info").hasClass('general_info_minimize')) {
                $("#report-item-group").removeClass("col-md-8 col-md-12");
                $("#general_report_info").removeClass("col-md-4 ");
                $("#report-item-group").addClass("col-md-7 ");
                $("#general_report_info").addClass("col-md-5");
    ...
    $("#general_info_minimize_arrow").on("click", function(e) {
        ...
        if ($(this).hasClass("fa-toggle-left")) {
            ...
            $("#report-item-group").removeClass("col-md-7 col-md-8");
            ...
            $("#general_report_info").removeClass("col-md-4 col-md-5");
            $("#report-item-group").removeClass("col-md-12 col-md-8");
    ...
    $("#tblProjectList tbody").on("click", "tr td", function(e) {
        ...
        if ($("#chkOpenNewTag").prop("checked") == true) {
            ...
            //alert(search_states);
            if ($("#projectName").html() != "")
                window.open("/iPD/project/report/" + projectCode + "/" + JSON.stringify(search_states), "_blank");
        }
        //perspective_images = [];
        ...
        if ($("#projectName").html() == "" || $("#chkOpenNewTag").prop("checked") == false) {
            ...
            if (reportInfo != null || reportInfo != undefined || reportInfo != "") {
                ...
                SetProjectReportInfo(reportInfo["currentWeekData"], "current")
...
function GetProjectReportByName(projectName) {
    ...
    $.ajax({
        ...
        async: false,
        type: 'post',
        data: { _token: CSRF_TOKEN, message: "get_report_byname", name: projectName, projectCode: projectCode },
        success: function(data) {
            //alert(JSON.stringify(data));
            console.log("================");
            console.log(data);
...
//     if (data != "") {
//         //console.log(data);
//         //alert(data[0]["branch_store"]);
//         $("#orderer").html(data[0]["orderer"]);
//         $("#designer").html(data[0]["sekkeisya"]);

//         $("#branch_store").html(data[0]["branch_store"]);
//         var tijou = "";
//         var tika = "";
//         if ((data[0]["tijou"]).trim() !== "") {
//             tijou = "地上 " + data[0]["tijou"] + " 階";
//         }
//         if ((data[0]["tika"]).trim() !== "") {
//             tika = "地下 " + data[0]["tika"] + " 階";
//         }

//         var structure = data[0]["kouzou"] + tika + tijou;
//         $("#structure").html(structure);
//         $("#builder").html(""); //data[0]["construction_type"]
//         $("#totalArea").html(data[0]["total_floor_area"])
//     }
//     else {
//         $("#orderer").html("");
//         $("#designer").html("");
...
function SetProjectReportInfo(info, weekParam) {
    //set current week values
    if (weekParam == "current" || weekParam == "report_byDate") {
        ...
        if (data["report"] != "") {
            $("#ipd_report").html(data["report"]);
            report_type_list.push("ipd_report");
        }
        if (data["leader_meeting_ipd_part1"] && data["leader_meeting_ipd_part1"].trim() != "" && data["leader_meeting_ipd_part1"] != undefined) {
            $("#leader_meeting_ipd_part1").html(data["leader_meeting_ipd_part1"]);
            report_type_list.push("leader_meeting_ipd_part1");
        }
        if (data["leader_meeting_ipd_part2"] && data["leader_meeting_ipd_part2"].trim() != "" && data["leader_meeting_ipd_part2"] != undefined) {
            $("#leader_meeting_ipd_part2").html(data["leader_meeting_ipd_part2"]);
            report_type_list.push("leader_meeting_ipd_part2");
        }
        if (data["leader_meeting_ipd_part3"] && data["leader_meeting_ipd_part3"].trim() != "" && data["leader_meeting_ipd_part3"] != undefined) {
            $("#leader_meeting_ipd_part3").html(data["leader_meeting_ipd_part3"]);
            report_type_list.push("leader_meeting_ipd_part3");
        }
        if (data["leader_meeting_techno_dept"] && data["leader_meeting_techno_dept"].trim() != "" && data["leader_meeting_techno_dept"] != undefined) {
            $("#leader_meeting_techno_dept").html(data["leader_meeting_techno_dept"]);
            report_type_list.push("leader_meeting_techno_dept");
        }
        if (data["architecture_leader_meeting_ipd_part1"] && data["architecture_leader_meeting_ipd_part1"].trim() != "" && data["architecture_leader_meeting_ipd_part1"] != undefined) {
            $("#architecture_leader_meeting_ipd_part1").html(data["architecture_leader_meeting_ipd_part1"]);
            report_type_list.push("architecture_leader_meeting_ipd_part1");
        }
        if (data["architecture_leader_meeting_ipd_part2"] && data["architecture_leader_meeting_ipd_part2"].trim() != "" && data["architecture_leader_meeting_ipd_part2"] != undefined) {
            $("#architecture_leader_meeting_ipd_part2").html(data["architecture_leader_meeting_ipd_part2"]);
            report_type_list.push("architecture_leader_meeting_ipd_part2");
        }
        if (data["architecture_leader_meeting_ipd_part3"] && data["architecture_leader_meeting_ipd_part3"].trim() != "" && data["architecture_leader_meeting_ipd_part3"] != undefined) {
            $("#architecture_leader_meeting_ipd_part3").html(data["architecture_leader_meeting_ipd_part3"]);
            report_type_list.push("architecture_leader_meeting_ipd_part3");
        }
        if (data["leader_meeting_civil_engineer"] && data["leader_meeting_civil_engineer"].trim() != "" && data["leader_meeting_civil_engineer"] != undefined) {
            $("#leader_meeting_civil_engineer").html(data["leader_meeting_civil_engineer"]);
            report_type_list.push("leader_meeting_civil_engineer");
        }
        if (data["structure_design_report"] && data["structure_design_report"].trim() != "" && data["structure_design_report"] != undefined) {
            $("#structure_report").html(data["structure_design_report"]);
            report_type_list.push("structure_report");
        }
        if (data["design_report"] && data["design_report"].trim() != "" && data["design_report"] != undefined) {
            $("#design_report").html(data["design_report"]);
            report_type_list.push("design_report");
        }
        if (data["estimation_report"] && data["estimation_report"].trim() != "" && data["estimation_report"] != undefined) {
            $("#estimation_report").html(data["estimation_report"]);
            report_type_list.push("estimation_report");
        }
        if (data["renewal_report"] && data["renewal_report"].trim() != "" && data["renewal_report"] != undefined) {
            $("#renewal_report").html(data["renewal_report"]);
            report_type_list.push("renewal_report");
        }
        if (data["equipment_design_report"] && data["equipment_design_report"].trim() != "" && data["equipment_design_report"] != undefined) {
            $("#equipment_design_report").html(data["equipment_design_report"]);
            report_type_list.push("equipment_design_report");
        }
        if (data["quality_control_report"] && data["quality_control_report"].trim() != "" && data["quality_control_report"] != undefined) {
            $("#quality_control_report").html(data["quality_control_report"]);
            report_type_list.push("quality_control_report");
        }
        if (data["construction_report"] && data["construction_report"].trim() != "" && data["construction_report"] != undefined) {
            $("#construction_report").html(data["construction_report"]);
            report_type_list.push("construction_report");
        }
        if (data["production_engineer_report"] && data["production_engineer_report"].trim() != "" && data["production_engineer_report"] != undefined) {
            $("#production_engineer_report").html(data["production_engineer_report"]);
            report_type_list.push("production_engineer_report");
        }
        if (data["production_design_report"] && data["production_design_report"].trim() != "" && data["production_design_report"] != undefined) {
            $("#production_design_report").html(data["production_design_report"]);
            report_type_list.push("production_design_report");
        }
        if (data["construction_office_report"] && data["construction_office_report"].trim() != "" && data["construction_office_report"] != undefined) {
            $("#construction_office_report").html(data["construction_office_report"]);
            report_type_list.push("construction_office_report");
        }
        if (data["construction_equipment_report"] && data["construction_equipment_report"].trim() != "" && data["construction_equipment_report"] != undefined) {
            $("#construction_equipment_report").html(data["construction_equipment_report"]);
            report_type_list.push("construction_equipment_report");
        }
        if ($("#report_type option:selected").length == 0 || report_type_list.length == 0) { //display ipd report as default
            //alert($("#report_type option:selected").val() + "\n" + report_type_list);
            report_type_list.push("ipd_report");
        }
        ...
        if (weekParam == "report_byDate") {
            var tempArr = $("#date").val().split('-');
            var pre_date = tempArr[0] + "年" + tempArr[1] + "月" + tempArr[2] + "日"
            $("#todayDate").html(pre_date);
        }
        else {
            DisplayReportDate();
        }
...
function GetContentEditableText(str) {
    ...
    return str.replace(/<div>/gi, '<br>').replace(/<\/div>/gi, '');
}

function SaveData() {
    var projectName = $("#projectName").html();
    var report = GetContentEditableText($("#ipd_report").html());
    var leader_meeting_ipd_part1 = GetContentEditableText($("#leader_meeting_ipd_part1").html());
    var leader_meeting_ipd_part2 = GetContentEditableText($("#leader_meeting_ipd_part2").html());
    var leader_meeting_ipd_part3 = GetContentEditableText($("#leader_meeting_ipd_part3").html());
    var leader_meeting_techno_dept = GetContentEditableText($("#leader_meeting_techno_dept").html());
    var architecture_leader_meeting_ipd_part1 = GetContentEditableText($("#architecture_leader_meeting_ipd_part1").html());
    var architecture_leader_meeting_ipd_part2 = GetContentEditableText($("#architecture_leader_meeting_ipd_part2").html());
    var architecture_leader_meeting_ipd_part3 = GetContentEditableText($("#architecture_leader_meeting_ipd_part3").html());
    var leader_meeting_civil_engineer = GetContentEditableText($("#leader_meeting_civil_engineer").html());
    var structure_design_report = GetContentEditableText($("#structure_report").html());
    var design_report = GetContentEditableText($("#design_report").html());
    var estimation_report = GetContentEditableText($("#estimation_report").html());
    var renewal_report = GetContentEditableText($("#renewal_report").html());
    var equipment_design_report = GetContentEditableText($("#equipment_design_report").html());
    var quality_control_report = GetContentEditableText($("#quality_control_report").html());
    var construction_report = GetContentEditableText($("#construction_report").html());
    var production_engineer_report = GetContentEditableText($("#production_engineer_report").html());
    var production_design_report = GetContentEditableText($("#production_design_report").html());
    var construction_office_report = GetContentEditableText($("#construction_office_report").html());
    var construction_equipment_report = GetContentEditableText($("#construction_equipment_report").html());

    var description1 = ""; //$("#currentWeek #description1").val();
    var description2 = ""; // $("#currentWeek #description2").val();
    //alert(projectCode+"\n"+description1+"\n"+description2);
    var hashtag_list = [];
    $(".highlighter span").each(function() {
        hashtag_list.push($(this).html());
    });
    var report_with_style = $(".jqueryHashtags > .highlighter").html() != undefined ? $(".jqueryHashtags > .highlighter").html() : "";
    ...
    var save_info = {
        ...
        report_html_code: report_with_style
    };

    //console.log(report_with_style);return;
    //alert(report);return;
    if (projectCode != "" && projectCode != undefined) {
        $.ajax({
            url: "/iPD/report/save",
            type: 'post',
            data: { _token: CSRF_TOKEN, message: "save_info", save_info: JSON.stringify(save_info) },
            success: function(data) {
