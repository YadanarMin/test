...
@section('title', 'CCC - Backup settings')
...
<script>
 $(document).ready(function(){
    ...
    var content_name = "ﾓﾃﾞﾙﾊﾞｯｸｱｯﾌﾟ設定";
...
<div class="main-content">
    ...
    <div id="searchDiv">
        <h4 class="page-title">バックアップ設定</h4>             
        <div class="form-group has-search">
            <span class="glyphicon glyphicon-search form-control-feedback"></span>
            <input type="text" class="form-control" id="txtSearch" placeholder="プロジェクト検索">
            <input type="button" class="btn btn-primary" value="保存" onClick="SaveBackupSetting();" style="float:right;margin-top:-33px;"/>
        </div>
