...
@section('title', 'CCC - calc Kasetsu')
...
<!--ForKasetsuCalculation-->
<script type="text/javascript" src="../public/js/calcKasetsu.js"></script>  
<script type="text/javascript" src="../public/js/kasetsuModelViewer.js"></script>
<!--ForKasetsuCalculation-->
...
<script type="text/javascript" src="../public/js/kasetsuSelection.js"></script>
<script type="text/javascript" src="../public/js/myCustomSelection2.js"></script>
<script type="text/javascript" src="../public/js/showKasetsuDataTable.js"></script>
            ...
            <div class="menu-content">
                <div class="searchFilter">
                    ...
                    <div class="versionFilter">
                        ...
                        <input type="button" class="btn btn-primary" name="btnShowModel" id="btnShowModel" value="ShowModel" onClick="ShowModel()"/>
                        <br>
                        <br>
                        
                        <label>②カウントする重仮設を3Dビュー上で選択してください！<br>
                              <b>(※右下の赤色のボタンで範囲選択可能)​</b> </label>
                        <br>
                        <br>
                        
                        <label>③3Dビュー上で選択した重仮設の数量を表示します。<br>
                        (画面を下スクロールしてください)</label>
                        <br>
                        <input type="button" class="btn btn-primary" name="btnShowKasetsuData" id="btnShowKasetsuData" value="LoadData" onClick="LoadData()"/>
