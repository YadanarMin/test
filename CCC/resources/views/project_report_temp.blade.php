...
<script type="text/javascript" src="/iPD/public/js/projectReport_temp.js"></script>
...
<link href="/iPD/public/css/quill.snow.css" rel="stylesheet">
<link rel="stylesheet" href="https://cdn.quilljs.com/1.3.6/quill.bubble.css">

<!--<link href="/iPD/public/css/quill.mention.css" rel="stylesheet" />-->
<!-- <script src="/iPD/public/js/library/quill.mention.1.js"></script>-->
...
#confirm_popup_header{
   height: 30px;    
   background-color: #485778;/*#191970*/
   color:white;
   text-align: center;
   margin:0px;
}
...
<main>
    <!--<div id="editor" style="height:200px;" contenteditable="false">-->
                                   ...
                                   @foreach($report_category as $cate)
                                    <li id="{{$cate['default_name']}}_li" class="col-md-6">
                                      <div class="reports_header">
                                          {{$cate['name']}}
                                          <div class="quill.mention.1quill.mention.1">
                                              <!--<div id="toolbar">-->
    ...
    <div id="confirm_history_popup"class="">
        ...
        <div id="confirm_popup_body">
            ...
            <ul class="nav nav-tabs" role="tablist" id="report_history_tabs">
